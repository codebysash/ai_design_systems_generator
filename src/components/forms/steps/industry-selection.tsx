...
const componentTypes = [
  { value: 'basic', label: 'Basic Components', description: 'Buttons, inputs, cards, etc.' },
  { value: 'navigation', label: 'Navigation', description: 'Headers, menus, breadcrumbs' },
  { value: 'forms', label: 'Forms & Data Entry', description: 'Form controls, validation, steps' },
  { value: 'data', label: 'Data Display', description: 'Tables, lists, charts, badges' },
  { value: 'feedback', label: 'Feedback', description: 'Alerts, modals, tooltips, loading states' },
  { value: 'layout', label: 'Layout', description: 'Grids, containers, spacing utilities' },
]
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          This helps us tailor the design system to your industry's conventions and user expectations.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Select the types of components you need. We'll prioritize these in your design system.
        </p>
      ...
      <div className="rounded-lg bg-muted p-4">
        ...
        <div className="space-y-1 text-sm text-muted-foreground">
          <p>Industry: {selectedIndustry ? industries.find(i => i.value === selectedIndustry)?.label : 'Not specified'}</p>
          <p>Component types: {selectedComponents.length > 0 ? selectedComponents.length + ' selected' : 'All types included'}</p>
        </div>
      </div>
    </div>
  )
